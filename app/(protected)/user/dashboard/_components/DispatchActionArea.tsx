...
export function DispatchActionArea({
  ...
  inputs: OnputDispatch[]
  outputs: outPutDispatch[]
}) {
  const [dispatches, setDispatches] = useState<(OnputDispatch | outPutDispatch)[]>([...inputs, ...outputs])
              ...
              <div className="flex space-x-2">
                <Dialog>
                  ...
                  <DialogContent className="sm:max-w-[700px] h-[80%] md:max-w-4xl overflow-y-auto">
                    ...
                    <OnputDispatchForm onSubmit={(data) => setDispatches([...dispatches, data])} />
                  </DialogContent>
                </Dialog>
                <Dialog>
                  <DialogTrigger asChild>
