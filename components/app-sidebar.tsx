import { Blinds, PencilLine, LayoutGrid, Images, Siren, User, FileText, UsersRound } from "lucide-react"
     ...
     <Sidebar>
      <SidebarHeader className="w-full flex justify-start">
        <div className="text-lg font-semibold font-poppins text-black">
          <Image alt="Jigawa State ICT and Digital Economy" src={logo} className="h-12 object-contain" />
        </div>
      </SidebarHeader>
        <SidebarContent>
            <SidebarGroup>
        ...
        <SidebarFooter>
         <div className="items-center flex justify-between py-2 bg-white dark:bg-stone-950 px-3 rounded-xl w-full h-full">
                <DarkButton />
                <LogoutButton />
         </div>
        </SidebarFooter>
